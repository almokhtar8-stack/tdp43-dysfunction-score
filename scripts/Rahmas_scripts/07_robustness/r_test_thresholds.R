...
# Load DESeq2 results - assuming this path remains constant
...
write.csv(results_table, 
          "scripts/Rahmas_scripts/07_robustness/results/r_robustness_analysis.csv", 
          row.names = FALSE)
print(results_table)

cat("\n✅ Robustness analysis complete! File saved as r_robustness_analysis.csv\n")
